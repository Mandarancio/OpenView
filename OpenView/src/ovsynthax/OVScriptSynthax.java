...
public class OVScriptSynthax extends AbstractTokenMaker {
	private final static OperatorManager operators_ = new OperatorManager();
	private final static FunctionManager functions_ = new FunctionManager();
	private int currentTokenStart;
	private int currentTokenType;
	private TokenMap tokenMap;

	public OVScriptSynthax() {
		...
		tokenMap.put("@PRINT", Token.PREPROCESSOR);
