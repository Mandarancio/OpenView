...
public class Atan extends AbstractFunction {
	...
	private static final String description = "Returns the arc tangent of a value; the returned angle is in the range -pi/2 through pi/2.";

	public Atan() {
		super("atan", "ATan", description, 1);
	}
