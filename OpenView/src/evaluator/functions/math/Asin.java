...
public class Asin extends AbstractFunction {
    ...
    private static final String description = "Returns the arc sine of a value; the returned angle is in the range 0.0 through pi.";

    public Asin() {
        super("asin", "ASin", description, 1);
    }
...
// Check the number of argument
        if (arguments.length == 1) {
            ...
            if (value.getType().isNumeric()) {
                return new Value(new Double(Math.asin(value.getDouble())));
            }
